// pages/respondent_dashboard.jsx
    ...
    <main className="dashboard-page">
      <header className="dashboard-header">
        <div className="dashboard-brand">
          ...
          <h2 className="dashboard-page-title">Respondent Dashboard</h2>
      ...
      <section className="dashboard-card" aria-labelledby="dashboard-title">
        ...
        <p>Your account is connected and ready for the next rescue feature.</p>
      </section>
    </main>
  );
}